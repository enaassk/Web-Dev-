...
urlpatterns = [
    ...
    path('companies/<int:pk>/vacancies/', views.VacancyList.as_view(), name='company-vacancies'),
    ...
    path('vacancies/top_ten/', views.VacancyTopTen.as_view(), name='vacancy-top-ten'),
]
